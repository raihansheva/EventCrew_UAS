...
@section('content')
    ...
    <div class="modal fade" id="modalHapus{{ $event->id }}" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal fade" id="modalVerify{{ $event->id }}" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-center">
                    ...
                    <form action="{{ route('admin.event.verifikasi', $event->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                ...
                <div class="modal-body">
                    <div class="area-content-detail">
                        <div class="content-kiri">
                            <img class="img-event" src="{{ asset('storage/' . $event->poster) }}" alt="Poster Event" class="img-fluid">
                        </div>
                        <div class="content-kanan">
                            <div class="area-kiri-detail">
                                <div class="area-label">
                                    <label class="label-event" for=""><i class='bx bx-calendar-event'></i> Nama
                                        Event</label>
                                    <span class="value-event">{{ $event->nama_event }}</span>
                                </div>
                                <div class="area-label">
                                    <label class="label-event" for=""><i class='bx bx-map text-danger'></i> Lokasi</label>
                                    <span class="value-event">{{ $event->lokasi }}</span>
                                </div>
                                <div class="area-label">
                                    <label class="label-event" for=""><i class='bx bx-calendar-event'></i>
                                        Tanggal
                                        Mulai</label>
                                    <span class="value-event">{{ $event->tanggal_mulai }}</span>
                                </div>
                                <div class="area-label">
                                    <label class="label-event" for=""><i class='bx bx-calendar-check'></i>
                                        Tanggal
                                        Selesai</label>
                                    <span class="value-event">{{ $event->tanggal_selesai }}</span>
                                </div>
                            </div>
                            <div class="area-kanan-detail">
                                <div class="area-label">
                                    <label class="label-event" for=""><i class='bx bx-category'></i>
                                        Kategori</label>
                                    <span class="value-event">{{ $event->kategori->nama_kategori ?? '-' }}</span>
                                </div>
                                <div class="area-label">
                                    <label class="label-event" for=""><i class='bx bx-flag'></i> Status</label>
                                    <span class="value-event">{{ $event->status_event ?? '-' }}</span>
                                </div>
                                <div class="area-label">
                                    <label class="label-event" for=""><i class='bx bx-badge-check text-info'></i> Status
                                        Verifikasi</label>
                                        @if ($event->status_verifikasi == "disetujui")
                                        <span class="value-event" style="color: rgb(1, 209, 1); font-weight: bold;">
                                        @elseif ($event->status_verifikasi == "ditolak")
                                        <span class="value-event" style="color: red; font-weight: bold;">
                                        @else
                                        <span class="value-event" style="color: gray; font-weight: bold;">
                                        @endif
